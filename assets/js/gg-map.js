...
function render(listDisGGmap) { 
    const htmls = listDisGGmap.map((dt, index) => {
        ...
        return `
            ...
            <p>Tên cửa hàng: ${dt.tench}</p>
            <p class="datafilterdistrict" data-filter="${dt.ten}" style="margin-bottom: 0px;">
            <i class="twi-location-arrow1" aria-hidden="true" style="margin-right: 5px;display: unset;font-weight: bold;"></i>${dt.ten}
            </p>
            <a href="tel:${dt.sdt}"><i class="twi-phone" aria-hidden="true" style="margin-right: 4px;display: unset;font-weight: bold;color:#959595;"></i>${dt.sdt}</a>
            </li>
        `;
    });
